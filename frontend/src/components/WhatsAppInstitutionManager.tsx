      ...
      <div style={{ background: "#0f1f31", color: "#f8fafc", border: "1px solid #334155", borderRadius: 14, padding: 18, display: "grid", gap: 14 }}>
        ...
        {selected && <>
          ...
          {mode === "PROPIO_API" && <div style={{ display: "grid", gap: 8, borderTop: "1px solid #334155", paddingTop: 12 }}>
            ...
            {isProfe360 ? <><strong>Mantenimiento de conceptos — Profe360</strong><span>Agregá, editá o quitá conceptos y guardá los cambios. COMUNICADO utiliza notificacion_academica_general (8 parámetros actuales o 10 con teléfonos de consultas).</span><button type="button" disabled={loading} onClick={() => setTemplates((values) => [...values, { tipoMensaje: "", nombre: "", templateUuid: "", cantidadParametrosBody: 8, estado: "PENDIENTE" }])}>Agregar concepto</button></> : null}

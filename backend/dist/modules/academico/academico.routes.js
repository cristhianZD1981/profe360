...
function invalidDateRange(fechaInicio, fechaFin) {
...
function jsDayToSqlWeekday(jsDay) {
...
async function getDocentesCatalogo(pool, institucionId) {
    return pool.request()
...
async function getConfiguracionCorreoEstudiante(pool, institucionId) {
...
router.put("/configuracion-correo-estudiante", async (req, res) => {
    try {
        ...
        if (!dominio)
            return (0, http_1.badRequest)(res, "dominio es obligatorio");
        const dominioNormalizado = dominio.startsWith("@") ? dominio : `@${dominio}`;
        const pool = await (0, database_1.getPool)();
        const result = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("dominio", database_1.sql.NVarChar, dominioNormalizado)
            .query(`
        ...
        WHERE InstitucionId = @institucionId
      `);
        return (0, http_1.ok)(res, { dominio: result.recordset[0]?.DominioCorreoEstudiantil || dominioNormalizado }, "Configuración de correo estudiantil actualizada correctamente");
    }
    catch (error) {
...
router.post("/anios-lectivos", async (req, res) => {
    try {
        ...
        if (!nombre || !fechaInicio || !fechaFin) {
            return (0, http_1.badRequest)(res, "nombre, fechaInicio y fechaFin son obligatorios");
        }
        if (invalidDateRange(fechaInicio, fechaFin)) {
            return (0, http_1.badRequest)(res, "La fechaInicio no puede ser mayor que la fechaFin");
        }
        const pool = await (0, database_1.getPool)();
      ...
      `);
        ...
        const result = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("fechaInicio", database_1.sql.Date, fechaInicio)
            .input("fechaFin", database_1.sql.Date, fechaFin)
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Año lectivo creado correctamente");
    }
    catch (error) {
...
router.put("/anios-lectivos/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Año lectivo actualizado correctamente");
    }
    catch (error) {
...
router.delete("/anios-lectivos/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { AnioLectivoId: id }, "Año lectivo desactivado correctamente");
    }
    catch (error) {
...
router.patch("/anios-lectivos/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { AnioLectivoId: id }, "Año lectivo reactivado correctamente");
    }
    catch (error) {
...
router.post("/periodos", async (req, res) => {
    try {
        ...
        if (!isValidNonNegativeId(anioLectivoId) || !nombre || !isValidNonNegativeId(numeroOrden) || !fechaInicio || !fechaFin) {
            return (0, http_1.badRequest)(res, "anioLectivoId, nombre, numeroOrden, fechaInicio y fechaFin son obligatorios");
        }
        if (invalidDateRange(fechaInicio, fechaFin)) {
            return (0, http_1.badRequest)(res, "La fechaInicio no puede ser mayor que la fechaFin");
        }
        ...
        const anioValido = await pool.request()
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .input("institucionId", database_1.sql.Int, institucionId)
            .query(`
        SELECT TOP 1 AnioLectivoId
        FROM dbo.AnioLectivo
      ...
      `);
        if (!anioValido.recordset.length) {
            return (0, http_1.badRequest)(res, "El año lectivo no pertenece a la institución");
        }
        const duplicado = await pool.request()
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("numeroOrden", database_1.sql.Int, Number(numeroOrden))
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Período creado correctamente");
    }
    catch (error) {
...
router.put("/periodos/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Período actualizado correctamente");
    }
    catch (error) {
...
router.delete("/periodos/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { PeriodoId: id }, "Período desactivado correctamente");
    }
    catch (error) {
...
router.patch("/periodos/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { PeriodoId: id }, "Período reactivado correctamente");
    }
    catch (error) {
...
router.post("/grupos", async (req, res) => {
    try {
        ...
        if (!isValidNonNegativeId(anioLectivoId) || !nombre) {
            return (0, http_1.badRequest)(res, "anioLectivoId y nombre son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
        const duplicado = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
      ...
      `);
        ...
        const result = await pool.request()
            ...
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("nivel", database_1.sql.NVarChar, nivel || null)
            .input("jornada", database_1.sql.NVarChar, jornada || null)
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Grupo creado correctamente");
    }
    catch (error) {
...
router.put("/grupos/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Grupo actualizado correctamente");
    }
    catch (error) {
...
router.delete("/grupos/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { GrupoId: id }, "Grupo desactivado correctamente");
    }
    catch (error) {
...
router.patch("/grupos/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { GrupoId: id }, "Grupo reactivado correctamente");
    }
    catch (error) {
...
router.post("/materias", async (req, res) => {
    try {
        ...
        const duplicado = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("codigo", database_1.sql.NVarChar, codigo || null)
            .query(`
      ...
      `);
        ...
        const result = await pool.request()
            ...
            .input("codigo", database_1.sql.NVarChar, codigo || null)
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("descripcion", database_1.sql.NVarChar, descripcion || null)
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Materia creada correctamente");
    }
    catch (error) {
...
router.put("/materias/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Materia actualizada correctamente");
    }
    catch (error) {
...
router.delete("/materias/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { MateriaId: id }, "Materia desactivada correctamente");
    }
    catch (error) {
...
router.patch("/materias/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { MateriaId: id }, "Materia reactivada correctamente");
    }
    catch (error) {
...
async function getUltimaMatriculaHistorica(params) {
    ...
    const result = await pool.request()
        ...
        .input("anioLectivoIdActual", database_1.sql.Int, anioLectivoIdActual)
        .query(`
      SELECT TOP 1
        m.MatriculaId,
        m.AnioLectivoId,
...
function validarProgresionAcademica(params) {
    const { nivelAnterior, nivelNuevo, esRepitente, permiteExcepcionProgresion, justificacionExcepcion } = params;
    ...
    try {
      ...
      `);
        ...
        const historialResult = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("estudianteId", database_1.sql.Int, matricula.EstudianteId)
            .query(`
        SELECT
          m.MatriculaId,
          m.AnioLectivoId,
...
router.post("/matriculas", async (req, res) => {
    ...
    if (institucionId === null)
        return;
    const transactionPool = await (0, database_1.getPool)();
    const transaction = new database_1.sql.Transaction(transactionPool);
    try {
        const { estudianteId, grupoId, anioLectivoId, fechaMatricula, observacion, tipoMatricula, nivelAcademico, especialidad, seccionTexto, rutaTransporte, esRepitente, permiteExcepcionProgresion, justificacionExcepcion, correoEnvioBoleta, observacionesDetalle } = req.body;
        if (!isValidNonNegativeId(estudianteId) || !isValidNonNegativeId(grupoId) || !isValidNonNegativeId(anioLectivoId)) {
            return (0, http_1.badRequest)(res, "estudianteId, grupoId y anioLectivoId son obligatorios");
        }
        await transaction.begin();
        const activaMismoAnio = await transaction.request()
            .input("estudianteId", database_1.sql.Int, Number(estudianteId))
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .query(`
      ...
      `);
        ...
        const duplicada = await transaction.request()
            .input("estudianteId", database_1.sql.Int, Number(estudianteId))
            .input("grupoId", database_1.sql.Int, Number(grupoId))
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .query(`
      ...
      `);
        ...
        const insertMatricula = await transaction.request()
            ...
            .input("grupoId", database_1.sql.Int, Number(grupoId))
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .input("fechaMatricula", database_1.sql.Date, fechaMatricula || null)
            .input("observacion", database_1.sql.NVarChar, observacion || null)
            .input("usuarioRegistroId", database_1.sql.Int, req.auth?.usuarioId || req.auth?.userId || req.auth?.id || null)
            .query(`
      ...
      `);
        ...
        await transaction.request()
            .input("matriculaId", database_1.sql.Int, matricula.MatriculaId)
            .input("tipoMatricula", database_1.sql.NVarChar, tipoMatricula || null)
            .input("nivelAcademico", database_1.sql.TinyInt, Number(grupoInfo.NivelAcademico || nivelAcademico || 0) || null)
            .input("especialidad", database_1.sql.NVarChar, especialidad || grupoInfo.Especialidad || null)
            .input("seccionTexto", database_1.sql.NVarChar, seccionTexto || grupoInfo.GrupoNombre || null)
            .input("rutaTransporte", database_1.sql.NVarChar, rutaTransporte || null)
            .input("esRepitente", database_1.sql.Bit, !!esRepitente)
            .input("permiteExcepcionProgresion", database_1.sql.Bit, !!permiteExcepcionProgresion)
            .input("justificacionExcepcion", database_1.sql.NVarChar, justificacionExcepcion || null)
            .input("correoEnvioBoleta", database_1.sql.NVarChar, correoEnvioBoleta || null)
            .input("observacionesDetalle", database_1.sql.NVarChar, observacionesDetalle || null)
            .query(`
    ...
    try {
      ...
      `);
        ...
        const updateMatricula = await transaction.request()
            ...
            .input("fechaMatricula", database_1.sql.Date, fechaMatricula || null)
            .input("observacion", database_1.sql.NVarChar, observacion || null)
            .input("usuarioActualizaId", database_1.sql.Int, req.auth?.usuarioId || req.auth?.userId || req.auth?.id || null)
            .query(`
      ...
      `);
        ...
        const existeDetalle = await transaction.request()
            .input("matriculaId", database_1.sql.Int, id)
            .query(`
      ...
      `);
        ...
        await transaction.commit();
        return (0, http_1.ok)(res, updateMatricula.recordset[0], "Matrícula actualizada correctamente");
    }
    catch (error) {
...
router.delete("/matriculas/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { MatriculaId: id }, "Matrícula desactivada correctamente");
    }
    catch (error) {
    ...
    try {
      ...
      `);
        ...
        const activaMismoAnio = await pool.request()
            ...
            .input("anioLectivoId", database_1.sql.Int, row.AnioLectivoId)
            .input("id", database_1.sql.Int, id)
            .query(`
        SELECT TOP 1 MatriculaId
        FROM dbo.Matricula
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Matrícula reactivada correctamente");
    }
    catch (error) {
...
router.put("/matriculas/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Matrícula actualizada correctamente");
    }
    catch (error) {
        console.error("Error al actualizar matrícula:", error);
        if (error?.number === 2627 || error?.number === 2601) {
...
router.patch("/matriculas/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        WHERE MatriculaId = @id
      `);
        return (0, http_1.ok)(res, { MatriculaId: id }, "Matrícula reactivada correctamente");
    }
    catch (error) {
        console.error("Error al reactivar matrícula:", error);
        return res.status(500).json({
...
router.post("/asignaciones-docentes", async (req, res) => {
    try {
        ...
        if (institucionId === null)
            return;
        const { usuarioId, grupoId, materiaId, anioLectivoId, periodoId, tipoAsignacion } = req.body;
        if (!isValidNonNegativeId(usuarioId) || !isValidNonNegativeId(grupoId) || !isValidNonNegativeId(anioLectivoId) || !tipoAsignacion) {
            return (0, http_1.badRequest)(res, "usuarioId, grupoId, anioLectivoId y tipoAsignacion son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
        const duplicado = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("usuarioId", database_1.sql.Int, Number(usuarioId))
            .input("grupoId", database_1.sql.Int, Number(grupoId))
            .input("materiaId", database_1.sql.Int, materiaId ?? null)
            .input("anioLectivoId", database_1.sql.Int, Number(anioLectivoId))
            .input("periodoId", database_1.sql.Int, periodoId ?? null)
            .input("tipoAsignacion", database_1.sql.NVarChar, tipoAsignacion)
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Asignación docente creada correctamente");
    }
    catch (error) {
...
router.put("/asignaciones-docentes/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Asignación docente actualizada correctamente");
    }
    catch (error) {
...
router.delete("/asignaciones-docentes/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { AsignacionDocenteId: id }, "Asignación docente desactivada correctamente");
    }
    catch (error) {
...
router.patch("/asignaciones-docentes/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { AsignacionDocenteId: id }, "Asignación docente reactivada correctamente");
    }
    catch (error) {
...
router.post("/bloques-horarios", async (req, res) => {
    try {
        ...
        if (!nombre || !horaInicioSql || !horaFinSql || !isValidNonNegativeId(ordenVisual)) {
            return (0, http_1.badRequest)(res, "nombre, horaInicio, horaFin y ordenVisual son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
        const duplicado = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("horaInicio", database_1.sql.VarChar(8), horaInicioSql)
            .input("horaFin", database_1.sql.VarChar(8), horaFinSql)
            .query(`
      ...
      `);
        ...
        const result = await pool.request()
            ...
            .input("horaInicio", database_1.sql.VarChar(8), horaInicioSql)
            .input("horaFin", database_1.sql.VarChar(8), horaFinSql)
            .input("ordenVisual", database_1.sql.Int, Number(ordenVisual))
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Bloque horario creado correctamente");
    }
    catch (error) {
...
router.put("/bloques-horarios/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Bloque horario actualizado correctamente");
    }
    catch (error) {
...
router.delete("/bloques-horarios/:id", async (req, res) => {
    try {
        ...
        WHERE BloqueHorarioId = @id
          AND InstitucionId = @institucionId
      `);
        return (0, http_1.ok)(res, { BloqueHorarioId: id }, "Bloque horario eliminado correctamente");
    }
    catch (error) {
...
router.post("/grupos-materia", async (req, res) => {
    try {
        ...
        if (!isValidNonNegativeId(grupoId) || !isValidNonNegativeId(materiaId)) {
            return (0, http_1.badRequest)(res, "grupoId y materiaId son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
      ...
      `);
        if (!grupoValido.recordset.length) {
            return (0, http_1.badRequest)(res, "El grupo no pertenece a la institución");
        }
        const materiaValida = await pool.request()
            .input("materiaId", database_1.sql.Int, Number(materiaId))
            .input("institucionId", database_1.sql.Int, institucionId)
            .query(`
        SELECT TOP 1 MateriaId
        FROM dbo.Materia
      ...
      `);
        if (!materiaValida.recordset.length) {
            return (0, http_1.badRequest)(res, "La materia no pertenece a la institución");
        }
        const duplicado = await pool.request()
            .input("grupoId", database_1.sql.Int, Number(grupoId))
            .input("materiaId", database_1.sql.Int, Number(materiaId))
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Materia por grupo creada correctamente");
    }
    catch (error) {
...
router.put("/grupos-materia/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Materia por grupo actualizada correctamente");
    }
    catch (error) {
...
router.delete("/grupos-materia/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { GrupoMateriaId: id }, "Materia por grupo desactivada correctamente");
    }
    catch (error) {
...
router.patch("/grupos-materia/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { GrupoMateriaId: id }, "Materia por grupo reactivada correctamente");
    }
    catch (error) {
...
router.post("/horarios-grupo", async (req, res) => {
    try {
        ...
        if (!isValidNonNegativeId(grupoMateriaId) || !isValidNonNegativeId(bloqueHorarioId) || !isValidNonNegativeId(diaSemana)) {
            return (0, http_1.badRequest)(res, "grupoMateriaId, bloqueHorarioId y diaSemana son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
        const duplicado = await pool.request()
            .input("grupoMateriaId", database_1.sql.Int, Number(grupoMateriaId))
            .input("bloqueHorarioId", database_1.sql.Int, Number(bloqueHorarioId))
            .input("diaSemana", database_1.sql.Int, Number(diaSemana))
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Horario de clase creado correctamente");
    }
    catch (error) {
...
router.put("/horarios-grupo/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Horario de clase actualizado correctamente");
    }
    catch (error) {
...
router.delete("/horarios-grupo/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { HorarioGrupoId: id }, "Horario de clase desactivado correctamente");
    }
    catch (error) {
...
router.patch("/horarios-grupo/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, { HorarioGrupoId: id }, "Horario de clase reactivado correctamente");
    }
    catch (error) {
...
router.get("/dias-lectivos", async (req, res) => {
    try {
        ...
        ORDER BY CASE WHEN DiaSemana = 1 THEN 8 ELSE DiaSemana END
      `);
        const existentes = result.recordset;
...
router.put("/dias-lectivos", async (req, res) => {
    try {
        ...
        if (!dias || !dias.length) {
            return (0, http_1.badRequest)(res, "Debés enviar la lista de días lectivos");
        }
        ...
        if (diasNormalizados.some((d) => !diasValidos.has(d.diaSemana))) {
            return (0, http_1.badRequest)(res, "Hay días de semana inválidos en la solicitud");
        }
        const pool = await (0, database_1.getPool)();
        for (const diaBase of DIAS_LECTIVOS_CATALOGO) {
            const incoming = diasNormalizados.find((d) => d.diaSemana === diaBase.DiaSemana);
            const activo = incoming ? incoming.activo : false;
            await pool.request()
                .input("institucionId", database_1.sql.Int, institucionId)
                .input("diaSemana", database_1.sql.Int, diaBase.DiaSemana)
                .input("nombre", database_1.sql.NVarChar, diaBase.Nombre)
                .input("activo", database_1.sql.Bit, activo)
                .query(`
        ...
        ORDER BY CASE WHEN DiaSemana = 1 THEN 8 ELSE DiaSemana END
      `);
        return (0, http_1.ok)(res, result.recordset, "Días lectivos actualizados correctamente");
    }
    catch (error) {
...
router.post("/feriados", async (req, res) => {
    try {
        ...
        if (!fecha || !nombre)
            return (0, http_1.badRequest)(res, "fecha y nombre son obligatorios");
        const pool = await (0, database_1.getPool)();
        const result = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("fecha", database_1.sql.Date, fecha)
            .input("nombre", database_1.sql.NVarChar, nombre)
            .input("descripcion", database_1.sql.NVarChar, descripcion || null)
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Feriado creado correctamente");
    }
    catch (error) {
...
router.put("/feriados/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Feriado actualizado correctamente");
    }
    catch (error) {
...
router.delete("/feriados/:id", async (req, res) => {
    try {
      ...
      `);
        if (!result.recordset.length)
            return res.status(404).json({ ok: false, message: "Feriado no encontrado" });
        return (0, http_1.ok)(res, { FeriadoId: id }, "Feriado desactivado correctamente");
    }
    catch (error) {
...
router.patch("/feriados/:id/reactivar", async (req, res) => {
    try {
      ...
      `);
        if (!result.recordset.length)
            return res.status(404).json({ ok: false, message: "Feriado no encontrado" });
        return (0, http_1.ok)(res, { FeriadoId: id }, "Feriado reactivado correctamente");
    }
    catch (error) {
...
router.post("/fechas-clase", async (req, res) => {
    try {
        ...
        if (!isValidNonNegativeId(horarioGrupoId) || !fecha || !isValidNonNegativeId(periodoId)) {
            return (0, http_1.badRequest)(res, "horarioGrupoId, fecha y periodoId son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
        const horarioValido = await pool.request()
            .input("horarioGrupoId", database_1.sql.Int, Number(horarioGrupoId))
            .input("institucionId", database_1.sql.Int, institucionId)
            .query(`
      ...
      `);
        if (!horarioValido.recordset.length) {
            return (0, http_1.badRequest)(res, "El horario no pertenece a la institución");
        }
        const duplicado = await pool.request()
            .input("horarioGrupoId", database_1.sql.Int, Number(horarioGrupoId))
            .input("fecha", database_1.sql.Date, fecha)
      ...
      `);
        ...
        const result = await pool.request()
            .input("horarioGrupoId", database_1.sql.Int, Number(horarioGrupoId))
            .input("fecha", database_1.sql.Date, fecha)
            .input("periodoId", database_1.sql.Int, Number(periodoId))
            .input("esExtraordinaria", database_1.sql.Bit, esExtraordinaria ? 1 : 0)
            .input("observacion", database_1.sql.NVarChar, observacion || null)
            .query(`
      ...
      `);
        return (0, http_1.created)(res, result.recordset[0], "Fecha de clase creada correctamente");
    }
    catch (error) {
...
router.put("/fechas-clase/:id", async (req, res) => {
    try {
      ...
      `);
        ...
        return (0, http_1.ok)(res, result.recordset[0], "Fecha de clase actualizada correctamente");
    }
    catch (error) {
...
router.delete("/fechas-clase/:id", async (req, res) => {
    try {
        ...
        WHERE fc.FechaClaseId = @id
          AND g.InstitucionId = @institucionId
      `);
        return (0, http_1.ok)(res, { FechaClaseId: id }, "Fecha de clase eliminada correctamente");
    }
    catch (error) {
...
router.post("/fechas-clase/generar-automatico", async (req, res) => {
    try {
        ...
        if (institucionId === null)
            return;
        const { grupoMateriaId, periodoId, bloqueHorarioIdInicial, diaSemana, cantidadLeccionesPorDia } = req.body;
        if (!isValidNonNegativeId(grupoMateriaId) ||
            ...
            return (0, http_1.badRequest)(res, "grupoMateriaId, periodoId, bloqueHorarioIdInicial, diaSemana y cantidadLeccionesPorDia son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
      ...
      `);
        if (!grupoMateriaResult.recordset.length) {
            return (0, http_1.badRequest)(res, "La materia por grupo no pertenece a la institución");
        }
      ...
      `);
        if (!periodoResult.recordset.length) {
            return (0, http_1.badRequest)(res, "El período no pertenece a la institución");
        }
        const periodo = periodoResult.recordset[0];
        if (!periodo.FechaInicio || !periodo.FechaFin) {
            return (0, http_1.badRequest)(res, "El período seleccionado no tiene fecha de inicio y fin definidas");
        }
        const bloqueInicialResult = await pool.request()
            .input("bloqueHorarioIdInicial", database_1.sql.Int, Number(bloqueHorarioIdInicial))
            .input("institucionId", database_1.sql.Int, institucionId)
            .query(`
        SELECT TOP 1
          BloqueHorarioId,
      ...
      `);
        if (!bloqueInicialResult.recordset.length) {
            return (0, http_1.badRequest)(res, "El bloque horario inicial no pertenece a la institución");
        }
        const bloqueInicial = bloqueInicialResult.recordset[0];
        const bloquesConsecutivos = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("ordenVisual", database_1.sql.Int, Number(bloqueInicial.OrdenVisual))
            .input("cantidad", database_1.sql.Int, Number(cantidadLeccionesPorDia))
            .query(`
        SELECT TOP (@cantidad)
          BloqueHorarioId,
          Nombre,
      ...
      `);
        if (bloquesConsecutivos.recordset.length !== Number(cantidadLeccionesPorDia)) {
            return (0, http_1.badRequest)(res, "No existen suficientes bloques consecutivos desde la sesión inicial para cubrir la cantidad de lecciones por día");
        }
        ...
        const fechasObjetivo = enumerateDatesBetween(startDate, endDate).filter((d) => jsDayToSqlWeekday(d.getDay()) === Number(diaSemana));
        if (!fechasObjetivo.length) {
            return (0, http_1.badRequest)(res, "No se encontraron fechas válidas dentro del rango del período para ese día");
        }
        const feriadosResult = await pool.request()
            .input("institucionId", database_1.sql.Int, institucionId)
            .input("fechaInicio", database_1.sql.Date, periodo.FechaInicio)
            .input("fechaFin", database_1.sql.Date, periodo.FechaFin)
            .query(`
        SELECT Fecha
        FROM dbo.FeriadoInstitucional
        WHERE InstitucionId = @institucionId
      ...
      `);
        const feriadosSet = new Set(feriadosResult.recordset.map((x) => String(x.Fecha).slice(0, 10)));
        const horariosCreados = [];
        const fechasInsertadas = [];
        const conflictos = [];
        const omitidasPorFeriado = [];
        for (const bloque of bloquesConsecutivos.recordset) {
            const horarioExistente = await pool.request()
                .input("grupoMateriaId", database_1.sql.Int, Number(grupoMateriaId))
                .input("bloqueHorarioId", database_1.sql.Int, Number(bloque.BloqueHorarioId))
                .input("diaSemana", database_1.sql.Int, Number(diaSemana))
                .query(`
          SELECT TOP 1 HorarioGrupoId
          FROM dbo.HorarioGrupo
        ...
        `);
          ...
          `);
            ...
            for (const fecha of fechasObjetivo) {
                ...
                if (feriadosSet.has(fechaStr)) {
                    if (!omitidasPorFeriado.includes(fechaStr))
                        omitidasPorFeriado.push(fechaStr);
                    continue;
                }
                const choque = await pool.request()
                    .input("grupoId", database_1.sql.Int, Number(grupoMateria.GrupoId))
                    .input("fecha", database_1.sql.Date, fechaStr)
                    .input("bloqueHorarioId", database_1.sql.Int, Number(bloque.BloqueHorarioId))
                    .query(`
            SELECT TOP 1
              fc.FechaClaseId
          ...
          `);
                ...
                const existente = await pool.request()
                    .input("horarioGrupoId", database_1.sql.Int, horarioGrupoId)
                    .input("fecha", database_1.sql.Date, fechaStr)
                    .query(`
            SELECT TOP 1 FechaClaseId
            FROM dbo.FechaClase
...
router.post("/fechas-clase/reprogramar-desde", async (req, res) => {
    try {
        ...
        if (institucionId === null)
            return;
        const { grupoMateriaId, periodoId, fechaDesde, bloqueHorarioIdInicialNuevo, diaSemanaNuevo, cantidadLeccionesPorDiaNueva } = req.body;
        if (!isValidNonNegativeId(grupoMateriaId) ||
            !isValidNonNegativeId(periodoId) ||
            !fechaDesde ||
            ...
            return (0, http_1.badRequest)(res, "grupoMateriaId, periodoId, fechaDesde, bloqueHorarioIdInicialNuevo, diaSemanaNuevo y cantidadLeccionesPorDiaNueva son obligatorios");
        }
        const pool = await (0, database_1.getPool)();
        const grupoMateriaResult = await pool.request()
            .input("grupoMateriaId", database_1.sql.Int, Number(grupoMateriaId))
      ...
      `);
        ...
        const periodo = periodoResult.recordset[0];
        if (!periodo.FechaFin) {
            return (0, http_1.badRequest)(res, "El período no tiene fecha fin definida");
        }
        const startDate = new Date(fechaDesde);
        const endDate = new Date(periodo.FechaFin);
        if (startDate > endDate) {
            return (0, http_1.badRequest)(res, "La fechaDesde no puede ser mayor que la fecha fin del período");
        }
        const fechasConAsistencia = await pool.request()
            .input("grupoMateriaId", database_1.sql.Int, Number(grupoMateriaId))
            .input("fechaDesde", database_1.sql.Date, fechaDesde)
            .query(`
      ...
      `);
        if (fechasConAsistencia.recordset.length > 0) {
            return (0, http_1.badRequest)(res, "No se puede reprogramar desde esa fecha porque ya existen asistencias registradas en fechas futuras de esa materia");
        }
        await pool.request()
            .input("grupoMateriaId", database_1.sql.Int, Number(grupoMateriaId))
            .input("fechaDesde", database_1.sql.Date, fechaDesde)

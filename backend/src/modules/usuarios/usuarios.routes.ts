...
router.get("/", async (req, res) => {
  try {
    ...
    const request = pool.request()
      .input("institucionId", sql.Int, req.auth?.institucionId ?? null)
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (!correo || !password || !nombre) {
        return badRequest(res, "correo, password y nombre son obligatorios");
      }
      ...
      return created(res, createdUser, "Usuario creado correctamente");
    } catch (error: any) {
      try {
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (!correo || !nombre) {
        return badRequest(res, "correo y nombre son obligatorios");
      }
